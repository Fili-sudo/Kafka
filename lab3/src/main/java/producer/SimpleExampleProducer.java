...
public class SimpleExampleProducer {
  ...
  // private static final String OUR_BOOTSTRAP_SERVERS = "localhost:9092, localhost:9093, localhost:9094";
    ...
    public static void main(String[] args){
        ...
        ProducerRecord<String, String> data = new ProducerRecord<>("events2", "cheie", "event22");
        // create message for topic events2, no key
        ProducerRecord<String, String> data2 = new ProducerRecord<>("events2", "event33");

        // create message for topic events1, no key
        ProducerRecord<String, String> data1 = new ProducerRecord<>("events1",  "noKeyMessage221");
        ...
        try {
            ...
            LOG.info("bbbbbbbbbbbbbbbbbbbbbbbbb key = {}, value = {} ==> partition = {}, offset = {}", data2.key(), data2.value(), meta2.partition(), meta2.offset());
