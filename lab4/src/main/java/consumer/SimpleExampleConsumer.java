...
public class SimpleExampleConsumer {
    ...
    private static final Logger LOG2 = LoggerFactory.getLogger(SimpleExampleProducer.class);
    ...
    public void pollKafka(String kafkaTopicName){
        ...
        while (true){
            ...
            records.forEach(crtRecord -> {
                if(crtRecord.value().equals("v8")){
                    kafkaProducer.send("events1", crtRecord.value());
                }
